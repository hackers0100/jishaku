...
async def send_traceback(
    destination: typing.Union[discord_mod.abc.Messageable, discord_mod.Message],
    verbosity: int,
    ...
    for page in paginator.pages:
        if isinstance(destination, discord_mod.Message):
...
async def attempt_add_reaction(
    msg: discord_mod.Message,
    reaction: typing.Union[str, discord_mod.Emoji]
) -> typing.Optional[discord_mod.Reaction]:
    """
...
class ReplResponseReactor:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, message: discord_mod.Message, loop: typing.Optional[asyncio.BaseEventLoop] = None):
