...
if typing.TYPE_CHECKING:
    from discord_mod.types.components import ButtonComponent
...
def use_file_check(
    ...
    return all([
        ...
        (
            ...
            if ctx.guild and ctx.bot.intents.presences and isinstance(ctx.author, discord_mod.Member)
            else True
        )
    ])


_Emoji = typing.Union[str, discord_mod.PartialEmoji, discord_mod.Emoji]
...
class DynamicButton(ui.Button[V_co]):
    ...
    def __init__(
        self,
        callback: typing.Callable[[discord_mod.Interaction], typing.Coroutine[typing.Any, typing.Any, typing.Any]],
...
class PaginatorInterface(ui.View):  # pylint: disable=too-many-instance-attributes, too-many-public-methods
    ...
    def __init__(
        ...
        **kwargs: typing.Any
        ...
        self.button_start: DynamicButton[typing.Self] = DynamicButton(
            self.button_start_callback, self.button_start_label, style=discord_mod.ButtonStyle.secondary
        )
        self.button_previous: DynamicButton[typing.Self] = DynamicButton(
            self.button_previous_callback, self.button_previous_label, style=discord_mod.ButtonStyle.secondary
        )
        self.button_current: DynamicButton[typing.Self] = DynamicButton(
            self.button_current_callback, self.button_current_label, style=discord_mod.ButtonStyle.primary
        )
        self.button_next: DynamicButton[typing.Self] = DynamicButton(
            self.button_next_callback, self.button_next_label, style=discord_mod.ButtonStyle.secondary
        )
        self.button_last: DynamicButton[typing.Self] = DynamicButton(
            self.button_last_callback, self.button_last_label, style=discord_mod.ButtonStyle.secondary
        )
        self.button_goto: DynamicButton[typing.Self] = DynamicButton(
            self.button_goto_callback, self.button_goto_label, style=discord_mod.ButtonStyle.primary
        )
        self.button_close: DynamicButton[typing.Self] = DynamicButton(
            self.button_close_callback, self.button_close_label, style=discord_mod.ButtonStyle.danger
        )
    ...
    async def send_to(self, destination: discord_mod.abc.Messageable):
        """
        ...
        self.message = await destination.send(
            **self.send_kwargs, allowed_mentions=discord_mod.AllowedMentions.none()
        )
    ...
    async def interaction_check(self, *args: typing.Any):  # pylint: disable=arguments-differ
        ...
        *_, interaction = args  # type: ignore  #149
        interaction: discord_mod.Interaction
        return not self.owner or interaction.user.id == self.owner.id

    async def button_start_callback(self, interaction: discord_mod.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_previous_callback(self, interaction: discord_mod.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_current_callback(self, interaction: discord_mod.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_next_callback(self, interaction: discord_mod.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_last_callback(self, interaction: discord_mod.Interaction):  # pylint: disable=unused-argument
    ...
    class PageChangeModal(ui.Modal, title="Go to page"):
        ...
        page_number: ui.TextInput[ui.Modal] = ui.TextInput(label="Page number", style=discord_mod.TextStyle.short)
        ...
        async def on_submit(self, interaction: discord_mod.Interaction, /):
            try:
    ...
    async def button_goto_callback(self, interaction: discord_mod.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_close_callback(self, interaction: discord_mod.Interaction):  # pylint: disable=unused-argument
...
class PaginatorEmbedInterface(PaginatorInterface):
    ...
    def __init__(self, *args: typing.Any, **kwargs: typing.Any):
        self._embed = kwargs.pop('embed', None) or discord_mod.Embed()
        super().__init__(*args, **kwargs)
